    ...
    def init_default_funnel(db: Session):
        ...
        default_steps = [
            ...
            },
            {
                ...
                "instrucciones_agente": "Ya tienes los datos del cliente. Ahora identifica que necesita y como puedes ayudarle. Ofrece informacion relevante sobre los servicios.",
                "condiciones_avance": json.dumps([]),
            },
            {
                "nombre": "presentacion",
                "titulo": "Presentacion",
                "orden": 2,
                "descripcion": "Presentar la solucion al cliente",
                "instrucciones_agente": "Presenta la solucion adecuada al cliente basandote en sus necesidades y resuelve sus dudas.",
                "condiciones_avance": json.dumps([]),
            },
            {
                "nombre": "seguimiento",
